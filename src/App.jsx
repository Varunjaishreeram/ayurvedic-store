...
const products = [
...

    {
        ...
        price: 180.00,
        quantity: "70gm",
        img: "/Madhumeha_Churan.jpg", // use your uploaded image
        description: "Saatwik Madhumeha Churna is an Ayurvedic formulation designed to support healthy blood sugar and urine sugar levels. A blend of natural herbs traditionally used for managing Madhumeha (Diabetes).",
        howToUse: "Take 1 teaspoon (approx. 5g) with water twice a day after meals, or as directed by a physician.",
        benefits: [
            "Helps regulate blood sugar levels.",
            "Supports urinary health.",
            "Promotes overall metabolic balance.",
            "Made with pure Ayurvedic herbs."
        ],
        ingredients: "Gudmar (20g), Jamun (20g), Ajwain (20g), Lango (5g), Karega Beg (20g), Purasnava (5g), Dudhini (10g), etc...",
        rating: 4.5,
        reviews: [
